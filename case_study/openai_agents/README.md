...
SDK agents, tools, handoffs, context and guardrails express specialist boundaries while the canonical `ModelClient` retains complete model-call accounting.
...
Reproduce the [matched comparison](../../evaluation/comparison/README.md) and examine its fairness caveats.
